...
```
c4dc880d8ed6796f28718c76c99e410c110366fd6c47bd991b518b023b5c28c3
```

**docgraph-darwin-amd64.tar.gz**
```
31dbfa7f8d6748f7147863f1f0b9549f82ca83f0e9847bc45002520c7039a1e6
```

**docgraph-linux-amd64.tar.gz**
```
a8ae2cf4843b47316853ee5177c89599c9893eb6d256731db432ec4565846f71
```

**docgraph-linux-arm64.tar.gz**
```
a9223d01473554063b0bbb584b1e7c205271c6340db3d2826a50fdefff52c3cc
```

**docgraph-windows-amd64.zip**
```
b1cacd26d9d69cc7169f7a6fe73cce565868d7be6131cc1a925a16545ad1a88a
```
