...
```
f01d74a58fed6dfc2147242931e1b49936f9ad849d97a87cc48b64164d3a128c
```

**docgraph-darwin-amd64.tar.gz**
```
765554f54708a2517026dc763f9b220cd57fba0ac2e2f8bd99cbca9b0b1994c6
```

**docgraph-linux-amd64.tar.gz**
```
fe76835f5dd6b7466e53ba17e14c447f92a504bbbc0fea98e964de1c7b88c89a
```

**docgraph-linux-arm64.tar.gz**
```
b74d56f7ac62d053f2635164f64f2f299acfc918839e49d71be523955ba3ab67
```

**docgraph-windows-amd64.zip**
```
f047b25f655355d12618898e128b56e0aee770099e3b7a9ab843190f63fb0c3e
```
