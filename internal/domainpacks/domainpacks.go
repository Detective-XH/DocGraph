...
func BuiltinGovernancePack() Pack {
	return Pack{
		...
		Version:          "1.0.0",
		Domain:           "governance",
		Description:      "Typed governance metadata for lifecycle status, document supersession, review scheduling, ownership and approvals, sensitivity, and audience access controls.",
		Status:           "stable",
		BuiltIn:          true,
...
func BuiltinEntityPack() Pack {
	return Pack{
		...
		Version:          "1.0.0",
		Domain:           "entity",
		Description:      "Typed entity metadata for type classification, canonical naming, and alias declaration; activates entity source graph construction.",
		Status:           "stable",
		BuiltIn:          true,
		EnabledByDefault: true,
		MinSchemaVersion: 10,
...
func BuiltinResearchProvenancePack() Pack {
	return Pack{
		...
		Version:          "1.0.0",
		Domain:           "research",
		Description:      "Typed research provenance metadata for claims, evidence, source type, confidence, analyst workflow, event and assessment dates, temporal validity, and deliverable tracking.",
		Status:           "stable",
		BuiltIn:          true,
		EnabledByDefault: true,
		MinSchemaVersion: 7,
